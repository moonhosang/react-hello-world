...
const RELEASES = [
  {
    date: '2026-08-07',
    title: '컴포넌트 분리 이유 · 상태·상수·파생 · export 용어 · 폴더 정렬',
    groups: [
      {
        ch: '1 · 컴포넌트',
        items: [{ no: '🧩', t: '컴포넌트 쪼개는 이유 (신규 개념)', c: '별도 레슨 — "한 컴포넌트에 다 넣으면 안 돼?"에서 출발 · 재사용 · 정리 · (심화)성능·리렌더 · 예시 코드 + 라이브 · 전용용어는 옆에서 풀이' }],
      },
      {
        ch: '3 · 상태',
        items: [{ no: '3-3', t: '상태·상수·파생 (신규 레슨)', c: '"다른 값으로 계산되나?" 한 질문으로 셋을 가름 · 파생을 저장하면 어긋나는 동기화 버그 라이브 데모(저장 vs 계산) · 파생 어원 · 확인 드릴' }],
      },
      {
        ch: '공통 · 도구',
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ch: '📚 참고',
        items: [
          { no: '📚', t: 'MDN·위키백과 참고 링크', c: '용어 사전 20개 용어에 📚 참고 출처 + 곁가지 4곳(3-2 불변성 · 9-1 부수 효과 · 9-2 선언형 · J3 클로저) — 개념이 리액트 요령이 아니라 일반 SW/CS 원리임을 잇는다' },
        ],
      },
    ],
  },
...
export const CHANGELOG_LATEST = 'v20-2026-08-07'
