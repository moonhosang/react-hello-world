...
export default function Step7_2({ onGo }) {
  ...
  return (
    <section>
      ...
      <div className="card">
        <div className="file-label">📄 step8-2-global-state/index.jsx</div>
      ...
      <p className="section-desc">
        🤝 그런데 이 편함엔 대가가 있다 — <code>useContext</code>를 쓰면 그 컴포넌트는 <b>"이 Provider 안에서만 산다"</b>는
        <b> 보이지 않는 계약</b>에 묶인다. 이 <b>계약의 정체와 장단점</b>은 다음 <b>🤝 개념 · Context 계약</b>에서
        <b> 시각 데모</b>로 따로 다룬다.
      </p>
      <TechTags items={[{ label: '🤝 개념 · Context 계약', to: 7.25 }]} onGo={onGo} />
