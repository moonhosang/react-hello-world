...
| 하위 | 배우는 것 | 폴더 |
|---|---|---|
| **8-1** | prop drilling 문제 → `Provider`+`useContext`로 해결 (before/after) | `step8-1-context` |
| **8-2** | Provider에 상태+setter를 담아 **전역 상태** 관리 | `step8-2-global-state` |
...
→ 이전: [7단계 · 폼 입력 응용](../step7-forms/README.md) · 다음: [9단계 · useEffect](../step9-effects/README.md)
