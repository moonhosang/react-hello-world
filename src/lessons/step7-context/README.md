# 7단계 · Context — prop drilling 해결 / 전역 상태
...
| 하위 | 배우는 것 | 폴더 |
|---|---|---|
| **7-1** | prop drilling 문제 → `Provider`+`useContext`로 해결 (before/after) | `step7-1-context` |
| **7-2** | Provider에 상태+setter를 담아 **전역 상태** 관리 | `step7-2-global-state` |
...
→ 이전: [6단계 · 폼 입력 응용](../step6-forms/README.md) · 다음: [8단계 · useEffect](../step8-effects/README.md)
