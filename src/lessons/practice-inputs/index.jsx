// 📝 챕터 연습 · 입력 다루기 (config)
// controlled input을 5단계로 — 완성물은 하나(입력 + 글자 수 + 초기화), 채워진 양만 줄여가며.
// 단계별 사이드바 항목으로 쪼개 쓰려고, 컴포넌트 대신 데이터(config)를 export한다.
...
const PRACTICE = {
  shortTitle: '입력',
  header: 'input을 state에 묶어(controlled) 직접 다뤄 본다. value로 내리고 onChange로 올린다.',
