...
export default function Step8_4({ onGo }) {
  ...
  return (
    <section>
      ...
      <SourceTrace file="step9-5-refetch/index.jsx (핵심 effect)" code={REFETCH_CODE} steps={REFETCH_STEPS} />
      ...
      <div className="card">
        <div className="file-label">📄 step9-5-refetch/index.jsx</div>
      ...
      <div className="card">
        <div className="file-label">📄 step9-5-refetch/index.jsx · fetchUser(userId)</div>
        <div className="button-row">
          {[1, 2, 3].map((id) => (
