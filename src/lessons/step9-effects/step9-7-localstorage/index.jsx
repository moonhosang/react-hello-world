  ...
  return (
    <section>
      <header className="lesson-header">
        <span className="badge effect-badge">9-7</span>
      ...
      <SourceTrace file="step9-7-localstorage/index.jsx · PersistedNote" code={STORE_CODE} steps={STORE_STEPS} />

      {/* ── 라이브 데모 ── */}
      <span className="learn-tag">📎 학습 포인트 · lazy init(읽기) + useEffect(저장)을 합치면 "새로고침해도 남는" 값이 된다</span>
      <div className="card">
        <div className="file-label">📄 step9-7-localstorage/index.jsx</div>
        <PersistedNote />
      ...
      <Practice
        ...
        practiceFile="step9-effects/step9-7-localstorage/practice.jsx"
        solutionFile="step9-effects/step9-7-localstorage/solution.jsx"
