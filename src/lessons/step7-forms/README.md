...
| 하위 | 배우는 것 | 폴더 |
|---|---|---|
| **7-1** | 여러 입력 → 객체 하나로 관리 (공통 onChange) | `step7-1-form-state` |
| **7-2** | `onSubmit` · `preventDefault`로 제출 (방명록) | `step7-2-submit` |
...
→ 이전: [✅ 체크포인트 B](../../checkpoints/checkpointB-shopping/README.md) · 다음: [8단계 · Context](../step8-context/README.md)
