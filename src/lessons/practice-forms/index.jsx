// 📝 챕터 연습 · 폼 입력 응용
// 챕터 08(폼 입력 응용)을 종합하는 핸즈온 연습 — 같은 '방명록'을 스캐폴딩만 줄여가며 5단계로.
// 완성물은 모두 같다(solution.jsx).
  ...
  return (
    <section>
      <header className="lesson-header">
        ...
        <h2>폼 입력 응용 — 종합 연습</h2>
        <p>객체 state·공통 onChange·제출(preventDefault)을 직접 손으로 써 '방명록'을 만든다. 같은 결과를 5단계로.</p>
      </header>
