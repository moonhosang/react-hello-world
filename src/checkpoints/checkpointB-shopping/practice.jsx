...
// 3·4·6단계를 합쳐서 '추가 / 목록 / 삭제'가 되는 장보기 리스트를 만들어 보자.
//
// 할 일:
//   TODO 1: input을 controlled로 만든다 (value, onChange)   ← 4단계
//   TODO 2: '추가'를 누르면 items 배열에 새 항목을 넣는다     ← 3·6단계 (새 배열!)
//   TODO 3: items를 map으로 목록으로 그린다 (key)            ← 6단계
//   TODO 4: 각 항목의 ✕로 그 항목을 뺀다 (filter)            ← 6단계
