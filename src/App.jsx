...
const lessons = [
  ...
  { id: 5, title: '5단계 · 리스트 (투두)', subtitle: 'map · key · 조건부 렌더링', Component: Stage5, docs: [D.renderingLists, D.sharingState] },
  { id: 5.5, title: '✅ 체크포인트 B', subtitle: '장보기 리스트 (실습)', Component: CheckpointB, kind: 'checkpoint', docs: [D.renderingLists] },
  { id: 6.1, group: '6단계 · 폼 입력 응용', title: '6-1 · 여러 입력 → 객체', subtitle: 'state·객체·공통 onChange', Component: Step6_1, kind: 'sub', docs: [D.updatingObjects] },
  { id: 6.2, group: '6단계 · 폼 입력 응용', title: '6-2 · 폼 제출', subtitle: 'onSubmit · 방명록', Component: Step6_2, kind: 'sub', docs: [D.updatingObjects, D.updatingArrays] },
  { id: 6.3, group: '6단계 · 폼 입력 응용', title: '6-3 · 유효성 검사', subtitle: 'validate · 파생 에러 · select', Component: Step6_3, kind: 'sub', docs: [D.updatingObjects, D.input] },
  { id: 7.1, group: '7단계 · Context (전역 상태)', title: '7-1 · prop drilling → Context', subtitle: '문제 → Provider 해결', Component: Step7_1, kind: 'sub', docs: [D.context, D.useContext] },
  { id: 7.2, group: '7단계 · Context (전역 상태)', title: '7-2 · 전역 상태', subtitle: 'state + setter 공유', Component: Step7_2, kind: 'sub', docs: [D.context, D.useContext] },
  { id: 7.3, group: '7단계 · Context (전역 상태)', title: '7-3 · 멀티스텝 폼', subtitle: 'Context로 상태 공유', Component: Step7_3, kind: 'sub', docs: [D.context, D.useContext, D.reusingLogic] },
  { id: 8.1, group: '8단계 · useEffect', title: '8-1 · useEffect + 의존성', subtitle: '렌더 후 실행 · deps', Component: Step8_1, kind: 'sub', docs: [D.effects, D.useEffect] },
  { id: 8.2, group: '8단계 · useEffect', title: '8-2 · 정리(cleanup)', subtitle: '타이머 뒷정리', Component: Step8_2, kind: 'sub', docs: [D.effects, D.useEffect] },
  { id: 8.3, group: '8단계 · useEffect', title: '8-3 · 데이터 불러오기', subtitle: 'loading → data', Component: Step8_3, kind: 'sub', docs: [D.effects] },
  { id: 8.4, group: '8단계 · useEffect', title: '8-4 · 다시 불러오기', subtitle: '의존성 변경', Component: Step8_4, kind: 'sub', docs: [D.effects] },
  { id: 8.5, group: '8단계 · useEffect', title: '8-5 · localStorage 저장', subtitle: 'lazy init · JSON · 지속', Component: Step8_5, kind: 'sub', docs: [D.effects, D.useEffect] },
  { id: 9, title: '9단계 · 에러 읽는 법', subtitle: '고장난 코드 고치기', Component: Stage9, docs: [D.rulesOfHooks] },
  { id: 10, title: '10단계 · useReducer', subtitle: '상태 로직 모으기', Component: Step10Reducer, docs: [D.useReducer, D.extractingReducer] },
  { id: 11, title: '11단계 · 최적화', subtitle: 'memo · useMemo · useCallback', Component: Step11Optimize, docs: [D.memo, D.useMemo, D.useCallback] },
  { id: 12, title: '12단계 · Ref와 커스텀 훅', subtitle: 'useRef · 로직 재사용', Component: Step12RefHooks, docs: [D.useRef, D.manipulatingDom, D.reusingLogic] },
...
const CHAPTERS = {
  react: [
    ...
    { n: '05', title: '훅(Hook)이란', items: [3.81, 3.815, 3.82, 3.83, 3.84] },
    { n: '06', title: '입력 다루기', items: [4] },
    ...
    { n: '13', title: 'Ref와 커스텀 훅', items: [12] },
    { n: '14', title: '에러 읽는 법', items: [9] },
